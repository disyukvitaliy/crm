...
if defined?(Wice::Defaults)
  ...
  #
  # I overrid custom_dropdown just for input-sm css class. I don't know how else :)
  # It is not overridable via column method arguments
      # Wice::Defaults::ADDITIONAL_COLUMN_PROCESSORS = {
      #   custom_dropdown:  ['ViewColumnCustomDropdown', 'ConditionsGeneratorColumnCustomDropdown'],
      # }
  #
